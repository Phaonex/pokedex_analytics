...
import { PokedexValidationPipe, pokemonByIdSchema, requestPokedexdDto } from 'src/pipes/validations/pokedex/pokedex.validation/pokedex.validation.pipe';
...
export class PokedexController {
    ...
    getPokemonsDetailById(@Param("id") id: requestPokedexdDto): Observable<any[]> {
      return this.pockeApiService.queryRows({
